...
from config.config import BASE_DIR #config.py 경로 세팅.
...
def parse_args():
    ...
    parser.add_argument('--output_dir', dest='output_dir', default=str(base_path / 'output'), type=str)
    ...
    #####
    parser.add_argument('--model_path', dest='model_path', default=str(base_path / 'output' / 'yolov2_epoch_60.pt'), type=str)
    #####
